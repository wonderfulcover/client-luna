...
<template>
    <section id="utility" class=" max-w-screen-xl utility flex flex-col justify-start items-center gap-20 py-32" >
        ...
        <div class="relative" v-if="landingPageData?.utilityList && landingPageData?.utilityList.length > 0">
            <div 
                class="utility__list grid grid-cols-4 card-grid w-full h-full">
                <CommonUtilityCard 
